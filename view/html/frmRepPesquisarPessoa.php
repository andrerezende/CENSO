            ...
            <html>
                ...
                <!-- <div id="tudo"> -->
                    ...
                    <div id="conteudo">     
                        ...
                        <form id='frmRepPesquisarPessoa' name='frmRepPesquisarPessoa' action='../../controller/impressao/imprimir_pessoa.php' method='post' onsubmit="return validar('siape', 'Voce precisa preencher o Siape');" >
                            <table width="460" border="0" align='center' class="titulo-tabela">				
                                <tr>                                
                                    <td align="left">
                                        <label><b>Cadastro Funcional Individual</b></label>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="460" border="0" align='center' class="conteudo-tabela">
                                ...
                                <tr>
                                    <td width="90%" align="center">
                                        ...
                                        <input type="button" value="Voltar" onclick="javascript:window.location='frmRelatorios.php';" /> 
                                    </td>
                                </tr>
